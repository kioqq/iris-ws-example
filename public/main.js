$(function() {
  ...
  ws.On('login', function (data) {
    ...
    var message = "Welcome to KioshimA.FX Chat – ";
    log(message, {
      prepend: true
    });
    addParticipantsMessage(jsondata);
  });
  ...
  ws.On('user joined', function (data) {
    var jsondata = JSON.parse(data);
    log(jsondata.username + ' joined');
    addParticipantsMessage(jsondata);
  });

  // Whenever the server emits 'user left', log it in the chat body
  ws.On('user left', function (data) {
     var jsondata = JSON.parse(data);
    log(jsondata.username + ' left');
    addParticipantsMessage(jsondata);
